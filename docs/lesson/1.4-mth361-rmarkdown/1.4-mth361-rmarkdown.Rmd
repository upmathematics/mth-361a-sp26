...
In-class activities and worksheets must be submitted through Moodle as a single `.pdf` file. If the worksheet requires you to use RMarkdown, then both `.Rmd` and `.html` files must be included into the submission.
