...
Using the z-score transformation, the normal r.v. reduces to $$X \sim N(0,1),$$ with mean $0$ and standard deviation of $1$. The normal PDF reduces to the **standard normal PDF**, $$f(z) = \frac{1}{\sqrt{2 \pi}} \exp{\left(-\frac{z^2}{2}\right)}, \ -\infty < z < \infty.$$
...
::: {style="color: red;"}
$\star$ Note that the z-score $\displaystyle z_{0.90}$ can be computed using the R function of the inverse CDF of the standard normal distribution.
:::
::::
