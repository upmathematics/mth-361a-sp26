...
::: {style="color: red;"}
$\star$ The expected value of a Bernoulli random variable is simply its success probability $p$.
:::
...
::: {style="color: red;"}
$\star$ The expected value of a r.v. is always constant but the interpretation depends on context --*we will discuss more on this later*.
:::
