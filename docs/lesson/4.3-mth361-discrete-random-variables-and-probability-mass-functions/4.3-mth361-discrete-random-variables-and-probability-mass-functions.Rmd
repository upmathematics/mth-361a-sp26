...
:::: {.column width=70%}
* *Medical trials*: Estimating the number of contacts a person has before they become infected.
* *Quality control*: Finding the number of products inspected before detecting a defective product.
* *Finance*: Analyzing the number of insurance claims made before a large loss occurs.
* *Machine learning*: Optimizing how many iterations are necessary before a model fits into data.
* $\cdots$ etcetera
::::
...
:::: {.column width=70%}
* *Medical trials*: Testing a new vaccine on $200$ participants, where each participant either develops immunity or does not.
* *Quality control*: Selecting $200$ products from a large batch and counting the number of defective products.
* *Finance*: Counting the number of "up" days of a stock over the next $200$ days.
* *Machine learning*: Identifying an email whether they are spam or not in $200$ independent emails.
* $\cdots$ etcetera
::::
